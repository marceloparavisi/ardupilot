...
const AP_Param::Info Rover::var_info[] = {
    ...
    // @Param: MODE1
    // @DisplayName: Mode1
    // @Values: 0:Manual,1:Acro,3:Steering,4:Hold,10:Auto,11:RTL,12:SmartRTL,15:Guided,17:Controller
    // @User: Standard
...
void Rover::load_parameters(void)
{
    ...
    //SRV_Channels::set_default_function(CH_2, SRV_Channel::k_throttleLeft);
    //SRV_Channels::set_default_function(CH_4, SRV_Channel::k_throttleRight);
